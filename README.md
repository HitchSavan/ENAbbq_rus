...
Репозиторий русификатора для ENA: Dream BBQ от BARBEQUE TEAM
  ...
  (форк -==будет==- содержать полностью обновленный перевод, сделанный по личной вкусовщине)
</div>

>[!WARNING]
>
>Этот репозиторий использует в данный момент устаревшую версию установщика. Если он вам нужен отдельно посетите [BBQDeploy](https://github.com/bazelik-null/BBQDeploy)
